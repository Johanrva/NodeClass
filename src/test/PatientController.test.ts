...
describe ('PatientController', () => {
    ...
    describe ('createPatient', () => {
        ...
        it('should be handler an error and return 400 status when patient does not create', async () => {
            //Mock Process
        ...
        it('should be handler an error and return 400 status failed patient create', async () => {
            //Mock Process
            const error = new Error ('Internal Server Error');
            const patientReq: PatientReq = { nombre: 'Carlos', apellido: 'Caceres', identificacion: "123456789"};
